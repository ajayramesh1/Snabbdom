...
var view = function view() {
  ...
  }, "To do list"), (0, snabbdom_1.h)('input', {
    props: {
      type: "text",
  ...
  }, "Add"),, taskNode = tasks(values)]);
};
var tasks = function tasks(values) {
  return (0, snabbdom_1.h)('div', values.map(function (value, index) {
    return (0, snabbdom_1.h)('div', {
      ...
      class: {
        'col-md-8': true,
        'text-decoration-line-through': value.status === Status.completed
      }
    }, "".concat(value.title)), (0, snabbdom_1.h)('button', {
      class: {
        'col-md-3': true,
        'btn': true,
    ...
    }, " ".concat(value.status === Status.completed ? Status.todo : Status.completed))]), (0, snabbdom_1.h)('button', {
      class: {
        'btn': true,
        'btn-danger': true,
        'col-md-2': true
...
},{"snabbdom":"node_modules/snabbdom/build/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
